#!/usr/bin/env python3
"""
this script can be found at https://cat.eduroam.org/
I have not had a successful run without making changes to the .nmconnection file at the end,
so just going to save this here for future reference. Do not run this as part of a setup script for now.
...
Messages.cat_dir_exists = "Directory {} exists; some of its files may " \
    "be overwritten"
Config.instname = "The Ohio State University (OSU)"
Config.profilename = "eduroam for OSU users"
Config.url = "https://ocio.osu.edu"
Config.email = "8help@osu.edu"
Config.title = "eduroam CAT"
Config.server_match = "wireless.osu.edu"
...
Config.user_realm = "osu.edu"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:wireless.osu.edu']
Config.use_other_tls_id = False
Config.tou = """The Ohio State University has joined eduroam to provide Internet access to OSU students, faculty, and staff when visiting eduroam participating institutions. OSU users may use their OSU email address (e.g., buckeye.1@osu.edu) and password when connecting to the "eduroam" Wi-Fi network.

OSU provides authentication for this service; however, the local institution is responsible for providing connectivity. For difficulties authenticating to "eduroam", please contact the OSU IT Service Desk. For all other connectivity issues, please contact the local help desk."""
